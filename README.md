...
*(Video will show: scraping → AI scoring → scam detection → cover letter generation → auto-apply → inbox scan → dashboard)*
...
| **Auto-Apply Queue** | Jobs needing your approval before sending |
...
Your browser opens at **http://localhost:8000**. Click **Scrape Jobs** to start.
